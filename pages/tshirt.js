        ...
        <>
            <section className="text-gray-600 body-font">
                <div className="container px-5 py-24 mx-auto ">
                    ...
                    {Object.keys(products).length === 0 && <p>Sorry stuck is empty new things comming soon stay tuned</p>}
                            ...
                            return <Link passHref={true} key={products[item]._id} href={`/product/${products[item].slug}`}>
                                <div className="lg:w-1/4 md:w-1/2 p-4 w-full border-2">
                                    ...
                                    <div className="mt-4">
                                        ...
                                        <h4 className="text-gray-900 title-font text-lg font-medium">{products[item].title}</h4>
                                        ...
                                        <div className="mt-1">
                                            ...
                                            {products[item].color.includes('purple') && <button className="border-2 border-gray-300 ml-1 bg-purple-400 rounded-full w-6 h-6 focus:outline-none"></button>}
                                        </div>
