        ...
        <>
            ...
            <div className="flex items-center justify-center min-h-screen bg-gray-100">
                ...
                <div className="px-8 py-6 mt-0 text-left bg-white shadow-lg">
                    ...
                    {/* <Link href={'/signup'}><button className="px-6 py-2 mt-4 mx-auto justify-center flex text-white bg-blue-600 rounded-lg hover:bg-blue-900">Sign Up</button></Link> */}
                    <Link href={'/signup'}><a href="#" className="text-sm mx-auto justify-center flex text-blue-600 hover:underline">Or Sign Up</a></Link>
                    ...
                    <form onSubmit={SubmitFormData} method='POST'>
                        <div className="mt-4">
                            ...
                            <div className="flex items-baseline justify-between">
                                ...
                                <Link href={'/forgot'}><a href="#" className="text-sm text-blue-600 hover:underline">Forgot password?</a></Link>
                            </div>
                        </div>
                    </form>
                </div>
